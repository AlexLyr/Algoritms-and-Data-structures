...
//        Assert.assertEquals(hashTable.hashFun("test"), hashTable.hashFun("gelmo"));
    ...
    public void testFind() {
        ...
        hashTable.put("test");
        Assert.assertEquals(13, hashTable.find("test"));
        hashTable.put("test");
        hashTable.slots[13] = null;
        Assert.assertEquals(16, hashTable.find("test"));
        hashTable.put("hello");
        Assert.assertEquals(13, hashTable.find("hello"));
        Assert.assertEquals(-1, hashTable.find("not here"));
        hashTable.put("hello11");
        Assert.assertEquals(14, hashTable.find("hello11"));
    }
}