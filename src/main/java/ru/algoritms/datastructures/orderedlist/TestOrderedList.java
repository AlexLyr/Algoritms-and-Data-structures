...
public class TestOrderedList {
    ...
    public void shouldFindElement() {
        ...
        orderedList.find(5);
        orderedList.find(6);
        Assert.assertEquals(orderedList.find(1).value, (Integer)1);
        Assert.assertEquals(orderedList.find(3).value, (Integer)3);
        Assert.assertEquals(orderedList.find(5).value, (Integer)5);
